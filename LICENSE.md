# HIPPOCRATIC LICENSE 3.0 (WITH FREE CORE EXCEPTION)

**Version 3.0, October 2021 (Patched)**

This project is licensed under the Hippocratic License 3.0, which strictly prohibits the use of this software for military purposes, human rights violations, and extrajudicial killings. 

In addition to the standard ethical terms, this license includes a **Custom Commercial Free Access Exception** authored by the Licensor to govern corporate and commercial use.

---

## CUSTOM COMMERCIAL FREE ACCESS EXCEPTION
*(This section modifies the commercial rights granted in the standard license)*

As the Licensor, I grant Licensees the right to incorporate this Software (including any program, neural network model, weights, or architecture provided herein) into a larger commercial, corporate, or proprietary product (a "Larger Work"). 

However, this commercial right is strictly conditioned upon the following rules:

1. **Free Access to the Core Work:** If the Licensee monetizes, sells, or otherwise charges a fee for a Larger Work that incorporates this Software, the Licensee must ensure that the specific functionality, code, model, and architecture of this licensed Software remains accessible and usable entirely for free.
2. **Permitted Commercialization:** The Licensee may charge users for the surrounding ecosystem, proprietary user interfaces, server hosting, wrappers, or additional external features that do not involve or derive directly from this licensed Software.
3. **No Paywalling the Core:** The Licensee shall not place the standalone use, execution, or weights of this licensed program or neural network model behind a paywall. 

Failure to comply with these free access conditions immediately revokes all rights to use, modify, or distribute the Software.

---

## TERMS AND CONDITIONS 
*(Standard Hippocratic License 3.0 Text)*
