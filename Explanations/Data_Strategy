...
Apply FastMobileEnhancer (CLAHE) to those frames : code link : https://github.com/searchyxnoe/Word_level_slr/blob/main/Code/FastMobileEnhancer.py
...
Tensor format for storing the data [15,134]
...
---> more info by checking code, sorry : code link : https://github.com/searchyxnoe/Word_level_slr/blob/main/Code/Data_Extraction.py
